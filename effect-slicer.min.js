  ...
  return (
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: i }) {
        ...
        l = t => {
          e.slides.forEach(s => {
            const i = s.querySelectorAll('.swiper-slicer-image-clone'),
              r = s.querySelector('.swiper-slide-content')
                ...
                0 === t
                  ? ((s.style.transitionTimingFunction = 'ease-out'),
                    (s.style.transitionDuration = `${
                      e.params.speed +
                      (e.params.speed / (i.length - 1)) * (i.length - r - 1)
                    }ms`))
                  : ((s.style.transitionTimingFunction = ''),
                    (s.style.transitionDuration = `${
                      t + (t / (i.length - 1)) * (i.length - r - 1)
                    }ms`))
              })
          }),
            (function ({ duration: t }) {
      ...
      s('setTranslate', () => {
        ...
        s('init', () => {
          'slicer' === e.params.effect &&
            (r(), i('setTranslate', e, e.translate))
        }),
        s('resize init', () => {
